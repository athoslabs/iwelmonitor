...
class FastActingInsulinScreen extends StatefulWidget {
  const FastActingInsulinScreen({Key? key}) : super(key: key);

  static final String title = 'Date (Range) & Time';

  @override
  _FastActingInsulinScreenState createState() =>
      _FastActingInsulinScreenState();
}

class _FastActingInsulinScreenState extends State<FastActingInsulinScreen> {
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              child: Text('Save'),
              onPressed: () async {
                print('FAST-ACTING AMOUNT IS: $insulinValue');
                print('FAST-ACTING DATE: $selectedDate');
                print('FAST-ACTING TIME: $selectedTime');

                var user = _user!.userId;
                FastActingInsEvent newFastActingInsEvent = FastActingInsEvent(
                    userId: user,
                ...
                try {
                  await Amplify.DataStore.save(newFastActingInsEvent);
                } catch (e) {
